...
import com.example.yangjiakang.countrylistdemo.bean.CountryBean;
...
public class CommonUtil {
    ...
    public static ArrayList<CountryBean> getDefaultCountryData() {
        ...
        Gson gson = new Gson();
        TypeToken<List<CountryBean>> token = new TypeToken<List<CountryBean>>() {};
        return gson.fromJson(countryData, token.getType());
    }
}
